...
class MarkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create marker" do
    assert_difference('Marker.count') do
      post markers_url, params: { marker: { lose: @marker.lose, user_id: @marker.user_id, win: @marker.win } }
    end
  ...
  test "should update marker" do
    patch marker_url(@marker), params: { marker: { lose: @marker.lose, user_id: @marker.user_id, win: @marker.win } }
